 ...
 * 测试环境胜利数假数据
 */
public class BattleTblSqlGenerator2 {
    // select sum(b.battle_ranking) as win_amount,b.user_id,p.player_name,b.battle_time from mgame_battle_tbl b left join mgame_player_tbl p on b.user_id=p.user_id where b.match_id=55 and b.battle_ranking=1 group by b.user_id order by b.battle_ranking desc,b.battle_time,b.user_id desc;
    ...
    public static void main(String[] args) throws Exception {
        File battleTblSqlGeneratorFile = new File("d:\\tmp\\battleTblSql2.txt");
        ...
        for (int i = 0; i < 97; i++) {
            ...
            Integer userIdNum = userIdStartNum + i;
